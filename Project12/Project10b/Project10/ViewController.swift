...
class ViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        if let data = UserDefaults.standard.object(forKey: Keys.userDefaults) as? Data {
            if let decodedPersons = try? jsonDecoder.decode([Person].self, from: data) {
    ...
    func save() {
        ...
        if let json = try? jsonEncoder.encode(persons) {
            let userDefaults = UserDefaults.standard
            userDefaults.set(json, forKey: Keys.userDefaults)
        }
